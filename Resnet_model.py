...
def train_resnet_model(model, train_loader, val_inputs=None, val_coords=None, val_labels=None,
...
model = SDS_ResNetWithCoords(input_channels)
...
# Train the Model
# ---------------------------
trained_model, train_losses, val_losses = train_resnet_model(
    model,
    train_loader,
    val_loader,
    epochs=epochs,
